...
import time
import pickle
Param=np.loadtxt('SingleLineParameters_PCom.txt')
...
for SampleNumber in range(len(Param[:,0])):   #len(Param[:,0])
    ...
    TPAR[0,0]=22; TPAR[0,1]=8;
    TPAR[1,0]=16; TPAR[1,1]=18;
    TPAR[2,0]=12; TPAR[2,1]=40;
    TPAR[3,0]=10; TPAR[3,1]=10;
    TPAR[4,0]=14; TPAR[4,1]=20;
    TPAR[5,0]=12; TPAR[5,1]=4;
    TPAR[6,0]=8; TPAR[6,1]=0;
    SLD[:,0]=SLD1;
    ...
    MCPAR[5] = 500 # stepbase
    MCPAR[6] = 500 # steplength 
    ...
    if __name__ =='__main__':  
        ...
        BR[SampleNumber,0]=0; BR[SampleNumber,1]=100; BR[SampleNumber,2]=Pitch; BR[SampleNumber,3]=Angle; BR[SampleNumber,4:17]=UNCTAvg;
        np.savetxt('Com.csv',BR);
