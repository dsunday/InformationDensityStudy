...
import time
import pickle
Param=np.loadtxt('2AngleC_W12P32H25.txt')
...
for SampleNumber in range(len(Param[:,0])):   #len(Param[:,0])
    ...
    Qx[1,:] = Qxt[60+SelectAngle1,:];
    Qz[1,:] = Qzt[60+SelectAngle1,:];
    Qx[2,:] = Qxt[60,:];
    Qz[2,:] = Qzt[60,:];
    ...
    if __name__ =='__main__':  
        ...
        BR[SampleNumber,0]=W; BR[SampleNumber,1]=H; BR[SampleNumber,2]=Pitch; BR[SampleNumber,3]=SelectAngle1; BR[SampleNumber,4:17]=UNCTAvg;
        np.savetxt('2AngleC_W12P32H25.csv',BR);
