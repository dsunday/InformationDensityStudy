...
import time
Param=np.loadtxt('DoubleLineParameters_B1.txt')
...
def SimInt_ID2(FITPAR):
    ...
    (Coord)= CD.ID2CoordAssign(TPARs,SLD,Trapnumber,Pitch,X1)
...
def MCMC_ID2(MCMC_List):
    ...
    (UNCT_Param)=Uncertainty2(ReSampledMatrixI)
